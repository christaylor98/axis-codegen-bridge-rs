...
fn bridge_to_dec_emits_native_four_arg_call() {
    ...
    let src = emit_rust_lib_from_bundle(&bundle, "to_dec_smoke", &HashMap::new(), &HashMap::new(), &std::collections::HashSet::new(), &std::collections::HashSet::new())
...
fn bridge_to_float_emits_native_four_arg_call() {
    ...
    let src = emit_rust_lib_from_bundle(&bundle, "to_float_smoke", &HashMap::new(), &HashMap::new(), &std::collections::HashSet::new(), &std::collections::HashSet::new())
